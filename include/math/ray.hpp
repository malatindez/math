...
namespace mal_math
{
    ...
    private:
        ...
        vec3 origin_;         ///< The ray's starting point.
        vec3 direction_;      ///< The direction in which the ray extends.
        vec3 inv_direction_;  ///< The inverse of the ray's direction.
        ivec3 sign_;          ///< Sign of the inverse direction for each axis.
    };
}; // namespace mal_math